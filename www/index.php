	...
	<div class="pt-page pt-page-1">
		<div id="list_morceaux" class="list_musique">
			<ul class="list_scroll" data-role="listview" data-autodividers="true" data-filter="true" data-inset="true">
				...
				<li class="no-carat-l"><a class="no-margin txt-left list-central-morceaux" href="index.html"><div class="cover"><img class="default-cover-morceaux" src="img/covers/default.jpg" alt="Default cover" /></div><div class="morceaux-artist">Temps mort 2.0<br><span class="morceaux-artist-album">Booba - D.U.C</span></div> <?php if($user_logged == 1) { ?> <div class="edit_music_container"><img class="edit_music" src="img/edit_music.png"></div><?php } ?></a></li>
				<li class="no-carat-l"><a class="no-margin txt-left list-central-morceaux" href="index.html"><div class="cover"><img class="default-cover-morceaux" src="img/covers/default.jpg" alt="Default cover" /></div><div class="morceaux-artist">Virginia Kim<br><span class="morceaux-artist-album">Artist - Album</span></div> <?php if($user_logged == 1) { ?> <div class="edit_music_container"><img class="edit_music" src="img/edit_music.png"></div><?php } ?></a></li>
				<li class="no-carat-l"><a class="no-margin txt-left list-central-morceaux" href="index.html"><div class="cover"><img class="default-cover-morceaux" src="img/covers/default.jpg" alt="Default cover" /></div><div class="morceaux-artist">William Fisher<br><span class="morceaux-artist-album">Artist - Album</span></div> <?php if($user_logged == 1) { ?> <div class="edit_music_container"><img class="edit_music" src="img/edit_music.png"></div><?php } ?></a></li>
				<li class="no-carat-l"><a class="no-margin txt-left list-central-morceaux" href="index.html"><div class="cover"><img class="default-cover-morceaux" src="img/covers/default.jpg" alt="Default cover" /></div><div class="morceaux-artist">#BEWEMONAMI<br><span class="morceaux-artist-album">Niro - Si j'me souviens</span></div> <?php if($user_logged == 1) { ?> <div class="edit_music_container"><img class="edit_music" src="img/edit_music.png"></div><?php } ?></a></li>		
			</ul>
		</div>
	</div>
